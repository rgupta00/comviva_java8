...
import com.session1.ex6.case_study2.Dish.Type;

public class D_DishTesterExample2Sol {
	...
	public static void main(String[] args) {
		...
		allDishes.stream().collect(Collectors.groupingBy(D_DishTesterExample2Sol::getCalLevel));
